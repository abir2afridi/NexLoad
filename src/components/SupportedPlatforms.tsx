      ...
      <div className="flex flex-wrap justify-center gap-px max-w-xl">
        {PLATFORMS.map((plat) => {
          ...
          return (
            <div
              key={plat.name}
              className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-mono tracking-wider uppercase border transition-all cursor-default ${
                isActive
                  ? `${plat.color} bg-ink/5`
