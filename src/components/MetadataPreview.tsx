  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 md:gap-8 relative z-10">
        ...
        {analyzedMetadata.isEstimated && (
          <div className="lg:col-span-12 bg-amber/10 border border-amber/30 px-4 py-2.5 flex items-center gap-2">
            <svg className="w-4 h-4 text-amber shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" /></svg>
            <span className="text-[10px] font-mono text-amber/80">
              Duration and file size are estimated — actual values may differ
            </span>
          </div>
        )}
        {/* Left: Thumbnail */}
